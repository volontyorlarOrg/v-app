...
| `AccountMenu`                                                                                                                                      | The phone header's avatar popover, holding a `nav` named "Account menu": profile, settings, sign out. It has no desktop counterpart — the sidebar names those routes as links                                                                                                |
...
| `ProfileMeter` / `ProfileMeterSummary`                                                                                                             | The completeness bar: in full on the profile, with the missing fields named by `profile.completionFields` (short on purpose because they read as a list), the reason and a button; in summary in the dashboard hero's band, as a rail of the six fields, the meter and one sentence |
