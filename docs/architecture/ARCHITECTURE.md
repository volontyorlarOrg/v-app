...
| `src/components/settings/`                            | Preference switches, the connection list, the password connection form and the merge-request lists                                                                                                                                                                                                            |
