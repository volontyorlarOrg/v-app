...
| The leaderboard, the public handle, and where a handle is renamed                  | [`product/LEADERBOARD.md`](product/LEADERBOARD.md)                                                                     |
| Cards, the profile-only application, the review step, and the durable receipt      | [`product/APPLYING.md`](product/APPLYING.md)                                                                           |
